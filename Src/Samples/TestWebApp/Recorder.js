...
Recorder.keyHandler = function (event) {
    ...
    this.eventHandler(event, "Keypress");
}
...
Recorder.changeHandler = function(event) {
    ...
    this.eventHandler(event, "Change");
}
...
window.recorder.attachDocumentEvents();